    ...
    <div className="bg-discord_blue pb-8 md:pb-0">
      <div className="p-7 py-9 h-screen md:h-[83vh] md:flex relative">
        ...
        <div className="flex-grow">
          <img
            src="https://res.cloudinary.com/dil4vmd3n/image/upload/v1650053423/dis222-removebg_ip8jdn.png"
            // src="https://res.cloudinary.com/dil4vmd3n/image/upload/v1650053422/dis1-removebg-preview_wt9bob.png"
            alt=""
